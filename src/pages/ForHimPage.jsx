...
// Safe Mock Images (Cherished / Trending wale images use kiye hain)
import prod1 from '../assets/images/trending1.webp';
import prod2 from '../assets/images/trending2.webp';
import prod3 from '../assets/images/trending3.webp';
import prod4 from '../assets/images/trending4.webp';
import prod5 from '../assets/images/trending5.webp';

const forHimProductsData = [
  {
    id: 401,
    name: "Royal Lion Emblem Gold Ring",
    code: "FH-401",
    price: 85200,
    formattedPrice: "₹ 85,200",
    weight: "11.4 gm",
    weightRange: "10-20 gm",
    carat: "22KT Gold",
    color: "Yellow",
    category: "Ring",
  ...
  {
    id: 402,
    name: "Cuban Link Solid Gold Chain",
    code: "FH-402",
    price: 184500,
    formattedPrice: "₹ 1,84,500",
    weight: "24.5 gm",
    weightRange: "20-35 gm",
    carat: "22KT Gold",
    color: "Yellow",
    category: "Chain",
  ...
  {
    id: 403,
    name: "Diamond Studded Executive Kada",
    code: "FH-403",
    price: 320000,
    formattedPrice: "₹ 3,20,000",
    weight: "36.8 gm",
    weightRange: "35-50 gm",
    carat: "18KT Gold",
    color: "Rose",
    category: "Bracelet",
  ...
  {
    id: 404,
    name: "Geometric Diamond Solitaire Ring For Men",
    code: "FH-404",
    price: 145000,
  ...
  {
    id: 405,
    name: "Classic Anchor Link Gold Bracelet",
    code: "FH-405",
    price: 115000,
    formattedPrice: "₹ 1,15,000",
    weight: "16.8 gm",
    weightRange: "10-20 gm",
    carat: "22KT Gold",
    color: "Yellow",
    category: "Bracelet",
    collection: "Anniversary Gift",
    gender: "Gents",
    image: prod5
  }
];

export const ForHimPage = () => {
  const shopContext = useShop() || {};
  const { addToCart = () => {}, toggleWishlist = () => {}, wishlist = [] } = shopContext;
  ...
  }, [selectedWeights, selectedPrices, selectedCarats, selectedColors, selectedCategories, selectedCollections, sortBy]);
  ...
  return (
    <div className="w-full min-h-screen bg-[#FAF6F0] text-[#2C2C2C] pb-24">
      ...
      <div className="w-full bg-[#FCF9F2] border-b border-[#E8DFD1] py-7 px-4 sm:px-8 lg:px-12 text-center">
        <div className="flex items-center justify-center gap-3 mb-1 flex-wrap">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-normal tracking-tight">
            <span className="text-[#6B1F22]">FOR </span>
        ...
        <p className="text-xs text-gray-500 font-light tracking-wide mt-1">
          ...
          <span>Gifts</span>
          <span className="mx-1.5 text-gray-400">/</span>
          <span className="text-[#B47B2B] font-medium uppercase">FOR HIM</span>
        </p>
      </div>
      ...
      <div className="w-full px-4 sm:px-8 lg:px-12 pt-8">
        ...
        {/* Sticky Left Sidebar + Scrolling Right Grid */}
          ...
          >
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-2">
                {["10-20 gm", "20-35 gm", "35-50 gm"].map((weight) => {
                  const isChecked = selectedWeights.includes(weight);
                  return (
                    <label
                      key={weight}
                      onClick={() => handleToggle(selectedWeights, setSelectedWeights, weight)}
            ...
            {/* COLLECTION */}
            <div className="space-y-2.5">
              <h4 className="text-xs font-semibold text-[#B47B2B] uppercase tracking-wide">COLLECTION</h4>
              <div className="space-y-2">
                {[
                  "Anniversary Gift",
                  "Antique Collection",
                  ...
                  return (
                    <label
                      key={col}
                      onClick={() => handleToggle(selectedCollections, setSelectedCollections, col)}
                      className="flex items-center gap-2.5 text-xs text-gray-600 hover:text-black cursor-pointer select-none"
                    >
                      <div className={`w-4 h-4 rounded border flex items-center justify-center shrink-0 ${
                        isChecked ? 'bg-[#6B1F22] border-[#6B1F22] text-white' : 'border-[#D4C7B5] bg-white'
